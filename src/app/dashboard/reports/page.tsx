    ...
    <DashboardLayout>
      <div className="space-y-10 pb-20" dir="rtl">
           ...
           <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                 <Button 
                   ...
                   className="h-14 px-8 rounded-2xl border-slate-200 bg-white dark:bg-slate-900 font-bold gap-2 hover:bg-slate-50 transition-all active:scale-[0.98]"
                 >
                    <Download className="w-4 h-4" />
                    تصدير التقرير الموجز
                 </Button>
                 <Button variant="outline" className="h-14 px-8 rounded-2xl border-slate-200 bg-white dark:bg-slate-900 font-bold gap-2">
                    <Download className="w-4 h-4" />
        ...
        <div className="bg-white/50 dark:bg-slate-900/40 backdrop-blur-md p-6 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 flex flex-col lg:flex-row items-center gap-6">
           ...
           <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
              <div className="relative">
                 ...
                 <Input 
                  ...
                  className="h-14 pr-12 rounded-2xl bg-white dark:bg-slate-900"
                 />
              </div>
              <div className="relative">
                 <Calendar className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 w-4 h-4" />
           ...
           <Button variant="ghost" className="h-14 w-14 rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800">
