      ...
      <div className="space-y-8 pb-16" dir="rtl">
        <div className="relative overflow-hidden bg-white dark:bg-[#0f172a] p-10 md:p-12 rounded-[2.5rem] border border-slate-200/60 dark:border-slate-800 shadow-sm">
          <div className="relative z-10 space-y-4">
            ...
            <h1 className="text-3xl font-black text-slate-900 dark:text-white family-cairo tracking-tight">تعديل بيانات المستخدم</h1>
            <p className="text-sm font-medium text-slate-500 dark:text-slate-400">
              تحديث بيانات وصلاحيات المستخدم من صفحة مستقلة متوافقة مع تجربة التطبيق.
            </p>
          </div>
        </div>
